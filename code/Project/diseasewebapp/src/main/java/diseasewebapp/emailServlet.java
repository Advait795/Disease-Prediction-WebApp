...
public class emailServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        String body = "<html><body style='font-family: Arial, sans-serif; color: black;'>"
                ...
                + "<p>By using Naive Bayes, we can efficiently analyze complex health data and provide you with accurate risk assessments. This allows healthcare providers to identify high-risk individuals and implement targeted, personalized interventions for improved health outcomes.</p>"
